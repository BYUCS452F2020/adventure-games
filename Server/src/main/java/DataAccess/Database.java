...
//  private void createExperienceTable() throws DataAccessException {
//    try (Statement stmt = conn.createStatement()) {
//      String sql = "Create Table if not exists experience (" +
...
//    } catch (SQLException e) {
//      throw new DataAccessException(e.getMessage() + " SQL Error encountered while creating experience table");
//    }
//  }
